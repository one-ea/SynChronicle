...
func TestCommandChannelEnvAndStdin(t *testing.T) {
	...
	nt := Notification{Kind: "budget", Level: "warn", Title: "SynChronicle: 预算", Body: "已花费 $8.00"}
	...
	if got := strings.TrimSpace(string(env)); got != "budget|warn|SynChronicle: 预算|已花费 $8.00" {
