...
export interface HostDependencies { agent?: RuntimeAgent; store?: StorePort; askUser?: AskUserHandler; modelFactory?: ModelFactory; persistStreamDelta?: (sequence: number, text: string) => Promise<RuntimeStreamChunk> }
