...
[![npm](https://img.shields.io/npm/v/synchronicle?color=111111)](https://www.npmjs.com/package/synchronicle)
...
每本作品绑定启动目录。再次进入同一目录运行 `synchronicle`，系统会读取最近 checkpoint 并继续推进。
