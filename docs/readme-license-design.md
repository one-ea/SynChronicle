...
- Date: 2026-07-12
- Status: Approved
- Scope: README、视觉资源、GPL-3.0 版权信息、NOTICE、发布包

## 目标

为 SynChronicle 建立一份全新的产品首页型 README，并统一仓库、发布包和 GitHub 展示中的 GNU General Public License v3.0 信息。
...
使用 GNU General Public License v3.0 标准正文。`LICENSE` 保持 SPDX 可识别的标准文本，不加入会破坏自动识别的自定义前言。
